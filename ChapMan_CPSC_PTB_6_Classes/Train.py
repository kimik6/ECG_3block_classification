...
for fold in range(NumOfFold):
    ...
    checkpoint_filepath =f'/kaggle/working/ECG_3block_classification/ChapMan_CPSC_PTB_6_Classes/Weights/Model_weights_{fold}_6Class_Chap_CPSC_PTB_PAC.weights.h5'
    model_checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(
        filepath=checkpoint_filepath,
        save_weights_only=True,
        monitor='val_Recall',
